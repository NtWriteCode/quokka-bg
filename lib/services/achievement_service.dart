...
class AchievementService {
  static List<Achievement> get allAchievements => [
        ...
        Achievement(
          ...
          description: 'Win your first game with the "Solo game" mechanic',
          tier: AchievementTier.bronze,
          xpReward: 20,
        ...
        Achievement(
          id: 'solo_win_10',
          title: 'One Man Army',
          description: 'Win 10 games with the "Solo game" mechanic',
          tier: AchievementTier.silver,
          xpReward: 40,
          category: 'The Lone Wolf',
        ),
        Achievement(
          id: 'solo_plays_25',
          title: 'Hermit',
          description: 'Log 25 sessions with the "Solo game" mechanic',
          tier: AchievementTier.gold,
          xpReward: 80,
          category: 'The Lone Wolf',
        ),
        Achievement(
          id: 'solo_own_5',
          title: 'Self-Reliant',
          description: 'Own 5 games with the "Solo game" mechanic',
          tier: AchievementTier.silver,
          xpReward: 40,
          category: 'The Lone Wolf',
        ),
        Achievement(
          ...
          description: 'Log play sessions for 10 distinct "Solo game" titles',
          tier: AchievementTier.gold,
          xpReward: 80,
          category: 'The Lone Wolf',
        ),
        ...
        Achievement(
          ...
          description: 'Own 5+ games with "Network and Route Building"',
          tier: AchievementTier.silver,
          xpReward: 40,
          category: 'The Specialist',
        ),
        Achievement(
          id: 'mech_powers',
          title: 'Specialist',
          description: 'Own 5+ games with "Variable Player Powers"',
          tier: AchievementTier.silver,
          xpReward: 40,
          category: 'The Specialist',
        ),
